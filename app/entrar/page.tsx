...
export default function EntrarPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // reset
    // redirectTo precisa ser uma URL ABSOLUTA
    ...
    <main className="min-h-screen bg-sand">
      ...
      <section className="mx-auto max-w-md px-4 py-14">
        <div className="rounded-3xl border border-black/10 bg-white/70 backdrop-blur p-8 shadow-[0_18px_50px_rgba(0,0,0,.08)]">
          ...
          {/* Toggle (login/signup) — escondemos no reset */}
          {mode !== 'reset' && (
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            ...
            {/* senha só aparece no login/signup */}
            {mode !== 'reset' && (
              <div>
            ...
            {/* link "esqueceu sua senha" (somente no login) */}
            {mode === 'login' && (
